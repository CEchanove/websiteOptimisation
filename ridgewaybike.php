...
<head>
    ...
    <meta name="description" content="Shop our range of Mountain Bikes online and in-store including the Ridgeway Performance Bike">
    <meta name="keywords" content="bike, bicycle, mountain, MTB, ridgeway, performance">
    <link rel="stylesheet" href="style.css">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link href="https://fonts.googleapis.com/css2?family=Poppins&display=swap" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.12.0-2/css/all.min.css" rel="stylesheet">
    <title>BKB | Ridgeway</title>
</head>
...
<?php include "bikemain.php"; ?>
    ...
    <article class="bike-background">
        ...
        <section class="tiagra-desktop">
            <img src="elements/bike6.png" alt="bicycle" class="tiagra-img" alt="A red bike">
